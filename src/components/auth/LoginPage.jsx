...
import { BarChart3, LogIn, Shield, Users, TrendingUp, Target, FileText } from "lucide-react";
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-900 via-blue-800 to-slate-900 flex items-center justify-center p-4 relative overflow-hidden">
        ...
        <div className="text-white space-y-8">
          <div className="space-y-6">
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-4xl font-bold tracking-tight">SEDRONAR</h1>
                <p className="text-blue-200 text-lg">Secretaría de Políticas Integrales sobre Drogas</p>
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <p className="text-blue-200 text-lg leading-relaxed">
                ...
                de rendimiento institucional. Gestione mediciones, establezca metas y 
                genere reportes ejecutivos con facilidad.
              </p>
            </div>
          </div>
        ...
        <div className="flex justify-center lg:justify-end">
          <Card className="w-full max-w-md shadow-2xl border-0 bg-white/95 backdrop-blur-sm">
            <CardHeader className="text-center pb-6 space-y-4">
              <div className="w-20 h-20 bg-gradient-to-br from-blue-600 to-blue-800 rounded-2xl flex items-center justify-center mx-auto shadow-lg">
      ...
      <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2 text-center">
        <p className="text-blue-200 text-sm">
          © 2024 SEDRONAR - Sistema de Indicadores v1.0
        </p>
      </div>
    </div>
  );
